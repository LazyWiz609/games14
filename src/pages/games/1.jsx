          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8 items-stretch">
            ...
            <div className="p-4 h-full">
              <div className="h-full min-h-[28rem] rounded-2xl shadow-xl bg-white/10 p-6 flex flex-col items-center hover:scale-105 hover:bg-white/15 transition-all duration-300 border border-white/10 backdrop-blur-md">
                ...
                <p className="text-white font-bold text-2xl mt-[16px]">Balloon Analogue Risk Task (BART) Practice</p>
                {/* Play Button */}
                <div className="mt-auto pt-6">
                  <Link to="/games/1/balloon" className="w-16 h-16 rounded-full border-4 text-white hover:text-[#474747] border-white flex items-center justify-center shadow-md hover:bg-white hover:scale-105 transition-all duration-300">
                    <svg
            ...
            <div className="p-4 h-full">
              <div className="h-full min-h-[28rem] rounded-2xl shadow-xl bg-white/10 p-6 flex flex-col items-center hover:scale-105 hover:bg-white/15 transition-all duration-300 border border-white/10 backdrop-blur-md">
                ...
                <p className="text-white font-bold text-2xl mt-[16px]">Delay Discounting</p>
                {/* Play Button */}
                <div className="mt-auto pt-6">
                  <Link to="/games/1/reward" className="w-16 h-16 rounded-full border-4 text-white hover:text-[#474747] border-white flex items-center justify-center shadow-md hover:bg-white hover:scale-105 transition-all duration-300">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 24 24"
            ...
            <div className="p-4 h-full">
              <div className="h-full min-h-[28rem] rounded-2xl shadow-xl bg-white/10 p-6 flex flex-col items-center hover:scale-105 hover:bg-white/15 transition-all duration-300 border border-white/10 backdrop-blur-md">
                ...
                <p className="text-white font-bold text-2xl mt-[16px]">Iowa Gambling Task</p>
                {/* Play Button */}
                <div className="mt-auto pt-6">
                  <Link to="/games/1/gambling" className="w-16 h-16 rounded-full border-4  text-white hover:text-[#474747] border-white flex items-center justify-center shadow-md hover:bg-white hover:scale-105 transition-all duration-300">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 24 24"
